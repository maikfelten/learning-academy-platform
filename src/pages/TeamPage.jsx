...
/**
 * Bereichsübersicht für Führungskräfte und HR - ausschließlich lesend.
 * Bewusst ohne Punktzahlen: nur Status (erfüllt / bald fällig / überfällig / offen).
 * Die Excel-Liste mit Prozentwerten bleibt dem Admin vorbehalten.
 */
  ...
  return (
    <div className="animate-fade space-y-5">
          ...
          <table className="w-full min-w-[720px] border-collapse text-[12.5px]">
            ...
            <tbody>
              {daten.zeilen.map((z) => {
                ...
                return (
                  <tr key={z.name} className="transition hover:bg-[var(--surface-hover)]">
                    <td className="border-b px-3.5 py-2.5 font-medium" style={{ borderColor: 'var(--tint-2)' }}>
                      {z.name}
                    </td>
                    <td className="border-b px-3.5 py-2.5 text-muted" style={{ borderColor: 'var(--tint-2)' }}>
                    ...
                    <td className="border-b px-3.5 py-2.5" style={{ borderColor: 'var(--tint-2)', color: 'var(--color-akzent-text)' }}>
                      {z.erfuellt}
                    </td>
                    <td className="border-b px-3.5 py-2.5" style={{ borderColor: 'var(--tint-2)', color: z.bald_faellig ? 'var(--color-status-soon)' : 'var(--text-faint)' }}>
                      {z.bald_faellig}
                    </td>
                    <td className="border-b px-3.5 py-2.5 font-semibold" style={{ borderColor: 'var(--tint-2)', color: z.ueberfaellig ? 'var(--color-status-late)' : 'var(--text-faint)' }}>
                      {z.ueberfaellig}
                    </td>
                    <td className="border-b px-3.5 py-2.5 text-faint" style={{ borderColor: 'var(--tint-2)' }}>
                      {z.offen}
      ...
      <p className="flex items-start gap-2 text-[11px] leading-relaxed text-faint">
        ...
        Betriebsrat zu beteiligen; in dieser Beta sind alle Personen außer dem Admin-Konto frei erfunden.
      </p>
    </div>
  )
}
